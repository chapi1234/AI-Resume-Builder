...
const Testimonial = () => {
  ...
  return (
    ...
    <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
        ...
        <Title title= 'What Our Users Are Saying' description='“Real stories from professionals who used ResumeAI to streamline their job applications and land interviews with confidence.”' />
    </div>
        <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
            <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-white to-transparent"></div>
            <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5">                    {[...cardsData, ...cardsData].map((card, index) => (
